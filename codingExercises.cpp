...
print_guest_list(guest_1,guest_2,guest_3);//----DO NOT MODIFY THE CODE ABOVE THIS LINE----
...
void clear_guest_list(string &guest_1,string &guest_2,string &guest_3) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE/----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
