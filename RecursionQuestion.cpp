...
double a_penny_doubled_everyday(unsigned int n, double amount = 0.01); //----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
int main()
{
    ...
    cout << function_activation_count;
}

//----DO NOT MODIFY THE CODE ABOVE THIS LINE----
//----WRITE THE FUNCTION DEFINITION BELOW THIS LINE----

double a_penny_doubled_everyday(unsigned int n, double amount)
{ //----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    ...
    if (n == 1)
        return amount;
    return (2 * a_penny_doubled_everyday(n - 1, amount));
